...
def make_pipeline():
    ...
    combined_factor = (
        4*value_winsorized.zscore() 
        + 4*quality_winsorized.zscore() 
        + sentiment_score_winsorized.zscore()
        + twitter_score_winsorized.zscore()        
        + news_score_winsorized.zscore()
        + 4*growth_winsorized.zscore()
        + 4*operation_margin_winsorized.zscore()
        + 4*net_margin_winsorized.zscore()
    )
